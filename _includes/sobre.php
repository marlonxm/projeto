<section id="sobre" class="bloco scrollspy">
		<div class="row container-esp">
			...
			<div class="col s12 m6">
				...
				<p>O mundo está atualisado e não podemos deixar você ficar para tras nesta batalha. </p>
				<p>Com o grande desenvolvimento tecnologico que estamos sofrendo atualmente, vimos a necessidade de criar oportunidade de coloca-lo aos olhos do mundo.</p>
				<p>Esteja no mundo digital</p>

				<aside>
						<i class="far fa-lightbulb center" ></i>
						<b>A sua ídeia em nossas mãos, se torna realidade.</b>
				</aside>
			</div>
