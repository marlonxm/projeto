			...
			<nav class="z-depth-0">
			    <div class="nav-wrapper">
			      ...
			      <ul class="left hide-on-med-and-down">
			        <li><a href="#banner" class="text-list">home</a></li>
			        <li><a href="#sobre" class="text-list">sobre</a></li>
			        <li><a href="#servicos" class="text-list">serviços</a></li>
			      </ul>


			       <ul class="right hide-on-med-and-down">
			        <li><a href="#planos" class="text-list">planos</a></li>
			        <li><a href="#newsletter" class="text-list">newsletter</a></li>
			        <li><a href="#contato" class="text-list">contato</a></li>
			      </ul> 
			    </div>
			  </nav>
		</div>		
